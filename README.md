**Mã nguồn Web client** [Xem ở đây ](https://github.com/nghuuquyen/sociss-weather-web)
 ...
 **e) Cơ sở lý thuyết về giao tiếp TCP/IP**
 ...
 ![TCP Sockets](./docs/images/tcp-sockets.jpg  "TCP Sockets")
...
![Deployment Diagram](./docs/images/sociss-weather-deploy-diagram.jpg  "Deployment Diagram")
...
![Main server ](./docs/images/sw-main-server.jpg  "Main server ")
...
![Other devices](./docs/images/sw-other-devices.jpg  "Other devices")
...
![Application activity ](./docs/images/sw-application-activity.jpg  "Application activity ")
...
![Get weather on server sequence](./docs/images/sw-sequence-diagram.jpg  "Get weather on server sequence")
...
![Sơ đồ hoạt động xem thời tiết](./docs/images/sw-client-activity.jpg  "Sơ đồ hoạt động xem thời tiết")
...
![weather popup ](./docs/images/weather-popup.png  "weather popup ")
